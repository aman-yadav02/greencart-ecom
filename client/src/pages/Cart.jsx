...
const Cart = () => {
    ...
    const placeOrder = async () => {
        try {
            if (!user || !user._id) return toast.error("User not authenticated. Please log in.");
                ...
                {!user ? (
                    <div className="text-center py-8">
                        ...
                        <button 
                            ...
                            className="bg-[#4fbf8b] text-white px-6 py-2 rounded-md hover:bg-[#44ae7c] transition-colors"
                        >
                            Login
                        </button>
                    </div>
                    ...
                    <div className="text-center py-8">
                        ...
                        <button 
                            ...
                            className="mt-4 bg-[#4fbf8b] text-white px-6 py-2 rounded-md hover:bg-[#44ae7c] transition-colors"
                        >
                            Continue Shopping
                        </button>
                    </div>
                            ...
                            {showAddress && (
                                <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full z-10">
                                    {addresses.map((address, index) => (
                                        <p key={address._id || index} onClick={() => { setSelectedAddress(address); setShowAddress(false); }} className="text-gray-500 p-2 hover:bg-gray-100 cursor-pointer">
